...
const kategoriaSchema = z
  .enum(["all", "z-klapka", "kubelkowe", "na-ramie", "listonoszki", "shoppery-tote"])
  .default("all")
  .catch("all");
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-4">
            ...
            <div className="space-y-3 max-w-2xl">
              ...
              <p className="text-sm sm:text-base text-muted-foreground font-light leading-relaxed">
                Przeglądaj pełną kolekcję torebek szytych ręcznie z certyfikowanych włoskich skór.
                Wybierz kategorię, odfiltruj nowości lub bestsellery i posortuj według preferencji.
              </p>
            </div>
          </div>
        </section>
