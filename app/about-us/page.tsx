...
const wartosci = [
  {
    icon: Gem,
    tytul: "Autentyczność",
    opis: "Każda torebka ma swoją historię. Projektujemy modele, które nie podążają za trendami — wyznaczają je. Ponadczasowa forma, która z biegiem lat zyskuje szlachetność.",
  },
  {
    icon: Scissors,
    tytul: "Rzemiosło",
    opis: "Nasi kaletnicy to mistrzowie z wieloletnim doświadczeniem. Każda torebka powstaje ręcznie — od pierwszego szwu po wykończenie krawędzi — z dbałością o każdy szczegół.",
  },
  {
    icon: Leaf,
    tytul: "Zrównoważony rozwój",
    opis: "Używamy wyłącznie certyfikowanej, garbowanej roślinnie włoskiej skóry. Minimalizujemy odpady, wybieramy lokalnych dostawców i kompensujemy ślad węglowy.",
  },
  {
    icon: Heart,
    tytul: "Pasja",
    opis: "Za każdą kolekcją stoi zespół ludzi, którzy kochają to, co robią. Projektowanie torebek to dla nas nie praca — to sztuka tworzenia przedmiotów, które towarzyszą w ważnych chwilach.",
  },
]
...
const proces = [
  {
    ...
    opis: "Każda kolekcja zaczyna się od moodboardu — zbieramy inspiracje z architektury, sztuki i natury. Następnie powstają szkice, a potem precyzyjne rysunki techniczne.",
    ikona: Eye,
  },
  {
    krok: "02",
    tytul: "Dobór skóry",
    opis: "Współpracujemy z renomowanymi toskańskimi garbarniami. Każda partia skóry jest starannie selekcjonowana pod kątem faktury, grubości i koloru.",
    ikona: Gem,
  },
  {
    krok: "03",
    tytul: "Ręczne szycie",
    opis: "Doświadczeni kaletnicy składają torebkę z ponad 50 indywidualnych elementów. Każdy szew jest podwójny, a krawędzie wielokrotnie szlifowane i malowane ręcznie.",
    ikona: Scissors,
  },
  {
    krok: "04",
    tytul: "Kontrola jakości",
    opis: "Przed opuszczeniem pracowni każda torebka przechodzi rygorystyczną kontrolę — sprawdzamy szwy, okucia, wykończenie skóry i ogólną harmonię formy.",
    ikona: ShieldCheck,
  },
]
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-4'>
            ...
            <div className='space-y-3 max-w-2xl'>
              ...
              <p className='text-sm sm:text-base text-muted-foreground font-light leading-relaxed'>
                LUXÉ BAGS to polska marka torebek tworzonych w duchu cichego
                luksusu. Poznaj naszą filozofię, ludzi i proces, który sprawia,
                że każda torebka jest wyjątkowa.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center'>
              ...
              >
                ...
                <div className='absolute -bottom-6 -right-4 sm:right-6 p-5 rounded-2xl bg-card/95 backdrop-blur-md border border-border shadow-xl max-w-xs space-y-1 text-card-foreground'>
                  ...
                  <p className='text-xs text-foreground font-medium'>
                    Projektujemy w Kołobrzegu, szyjemy z najlepszych włoskich
                    skór w naszej pracowni w Kołobrzegu.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className='space-y-4 text-muted-foreground text-sm sm:text-base font-light leading-relaxed'>
                  <p>
                    W 2018 roku dwie przyjaciółki — Ania i Kasia — postanowiły
                    stworzyć markę torebek, która będzie stanowić alternatywę
                    dla masowej mody. Chciały udowodnić, że prawdziwa elegancja
                    nie potrzebuje głośnych logotypów — wystarczy doskonała
                    forma i materiały najwyższej jakości.
                  </p>
                  <p>
                    Pierwsza kolekcja liczyła zaledwie pięć modeli. Każda
                    torebka była szyta ręcznie w warszawskiej pracowni, z
                    włoskiej skóry sprowadzanej z rodzinnej garbarni w okolicach
                    Florencji. Klientki pokochały te modele za ich
                    ponadczasowość i niezwykłą dbałość o detale.
                  </p>
                  <p>
                    Dziś LUXÉ BAGS to zespół dwunastu doświadczonych
                    rzemieślników, którzy łączą tradycyjne techniki kaletnicze z
                    nowoczesnym minimalistycznym wzornictwem. Wciąż wierzymy w
                    to samo — że piękno kryje się w prostocie i doskonałości
                    wykonania.
                  </p>
                </div>
              </motion.div>
        ...
        <section className='py-20 bg-surface text-foreground transition-colors duration-300'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center max-w-2xl mx-auto mb-14 space-y-3'>
              ...
              <p className='text-sm sm:text-base text-muted-foreground font-light leading-relaxed'>
                Cztery filary, na których opieramy każdą kolekcję i każdą
                decyzję biznesową.
              </p>
            </div>
        ...
        <section className='py-20 lg:py-28 bg-background text-foreground transition-colors duration-300'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center max-w-2xl mx-auto mb-14 space-y-3'>
              ...
              <p className='text-sm sm:text-base text-muted-foreground font-light leading-relaxed'>
                Ponad 40 godzin precyzyjnej pracy ręcznej. Cztery etapy, w
                których każdy detal jest przemyślany.
              </p>
            </div>
          ...
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
            ...
            >
              ...
              <blockquote className='font-serif text-2xl sm:text-3xl lg:text-4xl text-foreground leading-relaxed tracking-tight italic'>
                &ldquo;Chciałyśmy stworzyć torebki, które nie krzyczą luksusem,
                lecz go emanują. Modele, które z każdym noszeniem stają się
                bardziej osobiste — bo prawdziwa elegancja to ta, która nie
                potrzebuje słów.&rdquo;
              </blockquote>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
              ...
              >
                ...
                <p className='text-muted-foreground text-sm sm:text-base font-light leading-relaxed'>
                  Dwunastu doświadczonych rzemieślników, projektantów i
                  pasjonatów mody. Łączy nas jedno — wiara, że piękno kryje się
                  w szczegółach. Każdy z nas wnosi unikalne umiejętności,
          ...
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8'>
            ...
            >
              ...
              <p className='text-sm sm:text-base text-muted-foreground font-light leading-relaxed max-w-lg mx-auto'>
                Przeglądaj naszą kolekcję torebek szytych ręcznie z
                certyfikowanych włoskich skór. Znajdź model, który będzie
                towarzyszył Ci w ważnych chwilach.
              </p>
            </motion.div>
