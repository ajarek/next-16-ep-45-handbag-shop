...
export default function CheckoutPage() {
  ...
  const dalej = () => {
    ...
    if (etap === 1 && metodaPlatnosci === "blik") {
      ...
      if (!wynik.success) {
        setBłądBlik(wynik.error.issues[0]?.message || "Wprowadź 6-cyfrowy kod BLIK");
        return;
      }
      setBłądBlik("");
    }
        ...
        <section className="border-b border-border bg-surface transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-4">
            <nav className="flex items-center gap-1.5 text-[11px] uppercase tracking-[0.2em] text-muted-foreground">
              ...
              <ChevronRight className="w-3 h-3" />
              <span className="text-accent font-semibold">Realizacja zamówienia</span>
            </nav>

            <h1 className="font-serif text-2xl sm:text-3xl lg:text-4xl text-foreground tracking-tight">
              Realizacja <span className="italic font-normal text-accent">zamówienia</span>
            </h1>
          </div>
        </section>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span
                      className={`text-xs font-medium hidden sm:block transition-colors ${
                        idx <= etap ? "text-foreground" : "text-muted-foreground"
                      }`}
                    >
                      {etykieta}
                    </span>
                      ...
                      <div className="p-6 rounded-2xl bg-card border border-border space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <PoleFormularza
                            ...
                            onChange={(v) => setDaneDostawy({ ...daneDostawy, imie: v })}
                          ...
                          <PoleFormularza
                            ...
                            onChange={(v) => setDaneDostawy({ ...daneDostawy, nazwisko: v })}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <PoleFormularza
                            ...
                            onChange={(v) => setDaneDostawy({ ...daneDostawy, email: v })}
                          ...
                          <PoleFormularza
                            ...
                            onChange={(v) => setDaneDostawy({ ...daneDostawy, telefon: v })}
                        ...
                        <PoleFormularza
                          ...
                          onChange={(v) => setDaneDostawy({ ...daneDostawy, ulica: v })}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <PoleFormularza
                            ...
                            onChange={(v) => setDaneDostawy({ ...daneDostawy, kodPocztowy: v })}
                          ...
                          <PoleFormularza
                            ...
                            onChange={(v) => setDaneDostawy({ ...daneDostawy, miasto: v })}
                        ...
                        <div className="space-y-1.5">
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setDaneDostawy({ ...daneDostawy, uwagi: e.target.value })
                            }
                    ...
                    >
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">{metoda.opis}</p>
                              </div>
                              <div
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                                  wybrana ? "border-accent bg-accent" : "border-border"
                                }`}
                              >
                                {wybrana && <div className="w-2 h-2 rounded-full bg-white" />}
                              </div>
                            </button>
                          );
                        })}
                      ...
                      <div className="flex items-center gap-3 p-4 rounded-xl bg-secondary border border-border/50">
                        ...
                        <p className="text-[11px] text-muted-foreground font-light">
                          Wszystkie płatności są szyfrowane protokołem SSL. Nie przechowujemy
                    ...
                    >
                      ...
                      <div className="p-5 rounded-2xl bg-card border border-border space-y-3">
                        ...
                        <div className="text-xs text-muted-foreground space-y-0.5">
                          ...
                          {daneDostawy.uwagi && (
                            <p className="italic pt-1">Uwagi: {daneDostawy.uwagi}</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="p-5 rounded-2xl bg-card border border-border space-y-3">
                        ...
                        <p className="text-xs text-foreground font-medium">
                          {metodyPlatnosci.find((m) => m.id === metodaPlatnosci)?.nazwa}
                ...
                <div className="lg:sticky lg:top-28 space-y-5">
                  ...
                  <div className="p-5 rounded-2xl bg-secondary border border-border space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-semibold text-foreground">Darmowa dostawa</p>
                        <p className="text-[10px] text-muted-foreground">Dla zamówień od 299 zł</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-background text-accent flex items-center justify-center border border-border/50 shrink-0">
                      ...
                      <div>
                        <p className="text-xs font-semibold text-foreground">30 dni na zwrot</p>
                        <p className="text-[10px] text-muted-foreground">Bez podania przyczyny</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-background text-accent flex items-center justify-center border border-border/50 shrink-0">
                      ...
                      <div>
                        <p className="text-xs font-semibold text-foreground">Szybka wysyłka</p>
                        <p className="text-[10px] text-muted-foreground">1–2 dni robocze</p>
                      </div>
                    </div>
                  </div>
...
function PoleFormularza({
  ...
  return (
    <div className="space-y-1.5">
      ...
      />
      {blad && (
        <p className="text-[11px] text-rose-600 dark:text-rose-400 font-medium">{blad}</p>
      )}
    </div>
  );
}
