          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-4'>
            ...
            <div className='space-y-3 max-w-2xl'>
              ...
              <h1 className='font-serif text-3xl sm:text-4xl lg:text-5xl text-foreground tracking-tight'>
                Skontaktuj się <br className='hidden sm:inline' />
              ...
              <p className='text-sm sm:text-base text-muted-foreground font-light leading-relaxed'>
                ...
                umówić się na wizytę w showroomie? Jesteśmy do Twojej
                dyspozycji.
              </p>
            </div>
          </div>
                ...
                {sukces ? (
                  ...
                  >
                    ...
                    <p className='text-sm text-muted-foreground'>
                      ...
                      możliwe — zazwyczaj w ciągu kilku godzin.
                    </p>
                    <button
                      onClick={() => {
                        setSukces(false)
                  ...
                  <form onSubmit={wyslij} className='space-y-5'>
                    ...
                    >
                      <span>
                        {ładuje ? "Wysyłanie..." : "WYŚLIJ WIADOMOŚĆ"}
                      </span>
              ...
              >
                ...
                <div className='p-6 rounded-2xl bg-secondary border border-border space-y-3'>
                  ...
                  <p className='text-xs sm:text-sm text-muted-foreground font-light leading-relaxed'>
                    Odwiedź nas osobiście, aby zobaczyć i dotknąć każdą torebkę
                    z bliska. Nasi konsultanci pomogą dobrać idealny model i
                    kolor. Nie musisz się umawiać — wpadaj śmiało!
                  </p>
