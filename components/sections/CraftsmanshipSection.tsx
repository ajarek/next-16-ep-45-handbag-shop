...
export function CraftsmanshipSection() {
  ...
  return (
    <section
      id='rzemioslo'
      className='py-20 lg:py-28 bg-background text-foreground transition-colors duration-300 overflow-hidden'
    >
          ...
          >
            ...
            <div className='absolute -bottom-6 -right-4 sm:right-6 p-5 rounded-2xl bg-card/95 backdrop-blur-md border border-border shadow-xl max-w-xs space-y-1 text-card-foreground'>
              ...
              <p className='text-xs text-foreground font-medium'>
                Ponad 40 godzin precyzyjnej pracy ręcznej nad każdym pojedynczym
                egzemplarzem.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className='font-serif text-3xl sm:text-4xl lg:text-5xl text-foreground leading-tight tracking-tight'>
              ...
              <span className='italic font-normal text-accent'>
                ponadczasowego luksusu
              </span>
            </h2>

            <p className='text-muted-foreground text-sm sm:text-base font-light leading-relaxed'>
              W LUXÉ BAGS nie wierzymy w chwilowe trendy. Tworzymy torebki,
              które z każdym rokiem zyskują na szlachetności, stając się
              nieodłącznym elementem Twojej garderoby. Łączymy rzemieślnicze
              techniki szycia z nowoczesną, ergonomiczną formą.
            </p>
