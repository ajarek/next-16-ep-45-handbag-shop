...
export function NewsletterSection() {
  ...
  return (
    <section
      id='newsletter'
      className='py-20 bg-background text-foreground transition-colors duration-300 relative overflow-hidden'
    >
        ...
        >
          ...
          <div className='relative z-10 max-w-2xl mx-auto space-y-4'>
            ...
            <p className='text-sm sm:text-base text-muted-foreground font-light leading-relaxed'>
              ...
              na pierwsze zamówienie, wcześniejszy dostęp do limitowanych
              kolekcji i ekskluzywne zaproszenia na wydarzenia.
            </p>
            ...
            {isSuccess ? (
              ...
              >
                ...
                <p className='text-xs text-muted-foreground'>
                  Twój kod rabatowy:{" "}
                  <span className='font-mono font-bold text-sm bg-secondary px-3 py-1 rounded-lg text-foreground border border-border'>
                    LUXE10
                  </span>
                </p>
              </motion.div>
              ...
              <form onSubmit={handleSubmit} className='pt-6 space-y-3'>
                ...
                <div className='flex items-center justify-center gap-2 pt-1 text-xs text-muted-foreground'>
                  ...
                  >
                    Zgadzam się na otrzymywanie informacji handlowych i
                    akceptuję regulamin.
                  </label>
                </div>
