...
export function TestimonialsSection() {
  ...
  return (
    <section id="opinie" className="py-20 bg-surface text-foreground transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14 space-y-2">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground font-light">
            Zobacz, jak nasze torebki stają się nieodłączną częścią codzienności wyjątkowych kobiet.
          </p>
        </div>
            ...
            >
              ...
              <div className="pt-4 border-t border-border/60 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground">{rev.city} • <span>{rev.date}</span></p>
                </div>
