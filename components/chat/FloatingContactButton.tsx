  ...
  const handleQuickQuestion = (question: string) => {
    ...
    setTimeout(() => {
      ...
      if (question.includes("dostaw")) {
        reply = "Wszystkie zamówienia powyżej 299 zł wysyłamy kurierem gratis w 24h!";
        ...
        reply = "Nasze torebki są tworzone w 100% z włoskich skór garbowanych roślinnie w Toskanii.";
      }
          ...
          >
            ...
            <div className="p-4 bg-primary text-primary-foreground flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-serif text-sm font-semibold">Concierge LUXÉ</h4>
            ...
            <div className="px-3 py-2 bg-card border-t border-border flex gap-1.5 overflow-x-auto text-[10px]">
              ...
              <button
                onClick={() => handleQuickQuestion("Z jakiej skóry są torebki?")}
                className="whitespace-nowrap px-2.5 py-1 rounded-full bg-secondary text-foreground hover:bg-muted transition-colors"
              >
                ✨ Włoska skóra
              </button>
            ...
            <form onSubmit={handleSendMessage} className="p-3 border-t border-border flex items-center gap-2 bg-card">
              <input
                type="text"
                value={message}
