...
export function HeroSection() {
  return (
    <section
      id='hero'
      className='relative min-h-[85vh] lg:min-h-[90vh] flex items-center overflow-hidden py-12 lg:py-20 bg-background text-foreground transition-colors duration-300'
    >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center'>
          ...
          >
            ...
            <h1 className='font-serif text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] text-foreground leading-[1.12] tracking-tight'>
              ...
              podkreślają{" "}
              <span className='italic font-normal text-accent'>Twój styl</span>
            </h1>

            <p className='text-base sm:text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0 font-light leading-relaxed'>
              Odkryj wyjątkowe modele na każdą okazję. Ponadczasowa elegancja,
              szlachetna włoska skóra i nowoczesny minimalistyczny design.
            </p>
            ...
            <div className='relative w-full max-w-xl aspect-16/11 rounded-3xl overflow-hidden shadow-2xl border border-border bg-secondary group'>
              ...
              >
                ...
                <p className='text-muted-foreground line-clamp-2'>
                  „Niezwykle dopracowane detale, torebka zachwyca na żywo
                  każdego dnia.”
                </p>
